...
export const PromptManager: React.FC<PromptManagerProps> = ({ prompts, setPrompts, hasImage }) => {
  ...
  return (
    <div className="w-full">
      <h2 className="text-xl font-semibold mb-3 text-cyan-300">1. Add Prompts</h2>
        ...
        {prompts.map((prompt, index) => (
          <div key={index} className="flex items-center space-x-2">
            <textarea
              ...
              rows={3}
              className="flex-grow bg-gray-700 border border-gray-600 rounded-md px-3 py-2 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 outline-none transition-all resize-none"
            />
            <button
